...
function PlayLayer:ctor()   
	...
	self.m_backTileMapHeight=self.bgTitleMap:getMapSize().height*self.bgTitleMap:getTileSize().height
	...
	--ship life显示	
	local shipIcon=CCSpriteExtend.extend(CCSprite:create("ship01.png",CCRectMake(0, 0, 60, 38)))
