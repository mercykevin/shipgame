...
function MoonMenuScene:ctor()
	...
	newGameItemParams.image=CCSpriteExtend.extend(CCSprite:create("menu.png",CCRect(0, 0, 126, 33)))
	newGameItemParams.imageSelected=CCSpriteExtend.extend(CCSprite:create("menu.png",CCRect(0, 33, 126, 33)))
	newGameItemParams.imageDisabled=CCSpriteExtend.extend(CCSprite:create("menu.png",CCRect(0, 33*2, 126, 33)))
	...
	optionItemParams.image=CCSpriteExtend.extend(CCSprite:create("menu.png",CCRect(126, 0, 126, 33)))
	optionItemParams.imageSelected=CCSpriteExtend.extend(CCSprite:create("menu.png",CCRect(126, 33, 126, 33)))
	optionItemParams.imageDisabled=CCSpriteExtend.extend(CCSprite:create("menu.png",CCRect(126, 33*2, 126, 33)))
	...
	aboutItemParams.image=CCSpriteExtend.extend(CCSprite:create("menu.png",CCRect(126*2, 0, 126, 33)))
	aboutItemParams.imageSelected=CCSpriteExtend.extend(CCSprite:create("menu.png",CCRect(126*2, 33, 126, 33)))
	aboutItemParams.imageDisabled=CCSpriteExtend.extend(CCSprite:create("menu.png",CCRect(126*2, 33*2, 126, 33)))
...
function MoonMenuScene:shipFly()
	if not self.shipSp then
		self.shipSp=CCSpriteExtend.extend(CCSprite:create("ship01.png",CCRect(0, 45, 60, 38)))
