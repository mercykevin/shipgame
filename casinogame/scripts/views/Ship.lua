local Ship=class("Ship",function() 
	return CCSpriteExtend.extend(CCSprite:create("ship01.png",CCRectMake(0, 0, 60, 38))) end
)

function Ship:ctor()
	self.bulletSpeed=900
	local shipFrame0=CCSpriteFrame:create("ship01.png",CCRectMake(0, 0, 60, 38))
	local shipFrame1=CCSpriteFrame:create("ship01.png",CCRectMake(60, 0, 60, 38))
	local frames={}
	frames[1]=shipFrame0
	frames[2]=shipFrame1
